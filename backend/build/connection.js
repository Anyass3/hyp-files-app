...
export default async function () {
    ...
    let publicDriveKey = (_b = (_a = (await drivesBee.get('public'))) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.key;
    // let pcore = (await cores.get('private'))?.value?.key;// private core
    let privateDrivekey = (_d = (_c = (await drivesBee.get('private'))) === null || _c === void 0 ? void 0 : _c.value) === null || _d === void 0 ? void 0 : _d.key;
    //functions
    async function startDrive({ corestore, networker = undefined }, dkey, { replicate = false, name, announce = false, lookup = false }) {
    ...
    if (!publicDrive.writable) {
        ...
        if (!publicDrive.writable) {
            ...
            await drivesBee.put('public', { key: publicDrive === null || publicDrive === void 0 ? void 0 : publicDrive.$key, replicate: true });
        }
    }
    ...
    if (!publicDriveKey && publicDrive.writable) {
        emitter.log(colors.red('!publicDriveKey && publicDrive.writable'), !publicDriveKey && publicDrive.writable);
        await drivesBee.put('public', { key: publicDrive === null || publicDrive === void 0 ? void 0 : publicDrive.$key, replicate: true });
    }
    if (!privateDrivekey && privateDrive.writable) {
        emitter.log(colors.red('!privateDrivekey && privateDrive.writable'), !privateDrivekey && privateDrive.writable);
        await drivesBee.put('private', { key: privateDrive === null || privateDrive === void 0 ? void 0 : privateDrive.$key, replicate: false });
    }
    return async ({ channel, api = makeApi() }) => {
        ...
        // }
        if (!(publicDrive === null || publicDrive === void 0 ? void 0 : publicDrive.opened)) {
            emitter.log(colors.blue(`!publicDrive??.opened`), !(publicDrive === null || publicDrive === void 0 ? void 0 : publicDrive.opened));
            publicDrive = await startDrive(publicHyp, publicDriveKey, {
                replicate: false,
                name: 'public'
            });
        ...
        channel.on('drive-list', async ({ dkey, dir, ...opts }) => {
            ...
            const items = await ((_a = drive === null || drive === void 0 ? void 0 : drive.$list) === null || _a === void 0 ? void 0 : _a.call(drive, dir, false, { ...opts, paginate: true }));
        ...
        channel.on('drive-download', async ({ dkey, dir }) => {
            var _a;
            const drive = await api.drives.get(dkey);
            await ((_a = drive === null || drive === void 0 ? void 0 : drive.$download) === null || _a === void 0 ? void 0 : _a.call(drive, dir));
        });
        ...
        channel.on('paste-copied', async ({ src, dest }) => {
            ...
            publicDrive.$__copy__({
                path: src.path,
                isdrive: !!((_a = src.dkey) === null || _a === void 0 ? void 0 : _a.match(/[a-z0-9]{64}/)),
                drive: await api.drives.get(src.dkey)
            }, {
                path: dest.path,
                isdrive: !!((_b = dest.dkey) === null || _b === void 0 ? void 0 : _b.match(/[a-z0-9]{64}/)),
                drive: await api.drives.get(dest.dkey)
            });
        });
        channel.on('delete-path-item', async ({ path, dkey, name }) => {
            if (dkey === null || dkey === void 0 ? void 0 : dkey.match(/[a-z0-9]{64}/)) {
                const drive = await api.drives.get(dkey);
                if ((await drive.promises.stat(path)).isDirectory())

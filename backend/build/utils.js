...
export const spawnChildProcess = async (command, { shell = false, log = false, emitter, ...kwargs } = {}) => {
    return new Promise((resolve, reject) => {
...
export const getFileType = async (path) => {
    ...
    let _type = (_a = (await fileType.fromBuffer(buffer))) === null || _a === void 0 ? void 0 : _a.mime;
    if (!_type) {
        const res = await execChildProcess(`"file" "${path}"`);
        const typeOfFile = ((_d = (_c = (_b = res === null || res === void 0 ? void 0 : res.replace('\n', '')) === null || _b === void 0 ? void 0 : _b.split) === null || _c === void 0 ? void 0 : _c.call(_b, ':')) === null || _d === void 0 ? void 0 : _d[1]) || '';
        if (typeOfFile.includes('text'))
            _type = 'plain/text';
    }
    if (!_type)
        _type = mime.lookup(extname(path));
    return _type;
};
export const getDriveFileType = async (stream) => {
    var _a;
    let _type = (_a = (await fileType.fromStream(stream))) === null || _a === void 0 ? void 0 : _a.mime;
    return _type;
};

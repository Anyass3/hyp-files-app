...
import { getFileType, handleError, spawnChildProcess } from './utils.js';
...
export default async function (app, api = makeApi()) {
    ...
    app.post('/get-file-type', async function (req, res) {
        ...
        let storage = (_a = req === null || req === void 0 ? void 0 : req.body) === null || _a === void 0 ? void 0 : _a.storage; //drive || fs
        const filePath = unescape(req.body.path);
        const fsFilePath = Path.join(config.fs, filePath);
        const dkey = (_b = req === null || req === void 0 ? void 0 : req.body) === null || _b === void 0 ? void 0 : _b.dkey;
        if (!storage)
            storage = (dkey === null || dkey === void 0 ? void 0 : dkey.match(/[a-z0-9]{64}/)) ? 'drive' : 'fs';
        let ctype;
        if (storage === 'fs')
            ctype = await handleError(getFileType, emitter)(fsFilePath);
        else {
